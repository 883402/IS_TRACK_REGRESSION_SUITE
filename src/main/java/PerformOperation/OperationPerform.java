...
//					driver = new FirefoxDriver();
					...
					//setAuthorInfoForReports();
					 //ATUReports.add("Launch application", LogAs.PASSED, new CaptureScreen(ScreenshotOf.DESKTOP));
					//driver.switchTo().alert().dismiss();
				}
					 catch (Exception e) {
						 //ATUReports.setAuthorInfo("Automation Tester", Utils.getCurrentTime(),"1.0");
						// setAuthorInfoForReports();
                         //ATUReports.add("Not able to launch application", LogAs.FAILED, new CaptureScreen(ScreenshotOf.DESKTOP));
			...
			{
				driver.quit();
				ATUReports.add("Value set", LogAs.INFO, new CaptureScreen(ScreenshotOf.DESKTOP));
	          	ATUReports.add("Close Browser", LogAs.PASSED, new CaptureScreen(ScreenshotOf.DESKTOP));
				break;
			}
			case "clean_up":
			{
			...
			case "click":
			{
				...
				try
				{
                	...
                	Thread.sleep(3000);
                	//ATUReports.add("Element click done", LogAs.PASSED, new CaptureScreen(ScreenshotOf.DESKTOP));
                	break;
				...
				catch(Exception e)
				{
					...
					//ATUReports.add("Element not found", LogAs.FAILED, new CaptureScreen(ScreenshotOf.DESKTOP));
			...
			case "capture_data":
			{
	         //for capturing data and writing in excel
		  	...
		  	//send file path as sValue
				...
				wb.write(fout);         
				fout.close();
				ATUReports.add("Value captured sucessfully", LogAs.PASSED, new CaptureScreen(ScreenshotOf.DESKTOP));
				break;
			}
				catch(Exception ex)
				{
                	ATUReports.add("Value is NULL", LogAs.FAILED, new CaptureScreen(ScreenshotOf.DESKTOP));
                	break;
                	}
        		}
